...
export default async function handler(req, res) {
  ...
  if (method === 'GET') {
    ...
    RUTA_STORAGE = "gs://vw-vwm-bi-anagp-p-evalpro-l44-archivos-audi-${process.env.AMBIENTE_PROD.toLowerCase()}/Escalamiento/escalamiento_${
    ...
    const query = `
      DELETE
      FROM
        STG_${process.env.AMBIENTE_PROD}.TB_ESCALAMIENTO
      WHERE
