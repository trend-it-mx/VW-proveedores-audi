          ...
          <table className="flex w-full flex-col gap-3">
            <thead className="align-bottom">
              {table.getHeaderGroups().map((headerGroup) => (
                <tr
                  key={headerGroup.id}
                  className="pl-10 grid grid-cols-12 justify-items-start font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70" >
            ...
            <tbody className="flex w-full flex-col gap-3">
              {table.getRowModel().rows.map((row) => {
                return (
                  <tr
                    key={row.id}
                    className="grid grid-cols-12 items-center items-center justify-items-start pl-4 text-base bg-transparent border-b text-sm shadow-transparent"
                  >
