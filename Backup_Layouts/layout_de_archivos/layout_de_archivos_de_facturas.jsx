...
const LayoutDeFacturas = ({ data, error }) => {
  useEffect(() => {
      ...
      <div className="flex w-full flex-col items-center gap-4">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            await toast.promise(
              axios.post(
                `${config.url.API_URL}/api/administracion/parametros/lay_archivo/?tabla=FACTURACION_VW`,
                values
              ),
              {
...
LayoutDeFacturas.auth = true;
export default LayoutDeFacturas;
// # sourceMappingURL=layout_de_archivos_de_ordenes.jsx.map
