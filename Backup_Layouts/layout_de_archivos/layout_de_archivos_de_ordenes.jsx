...
const LayoutDeOrdenes = ({ data, error }) => {
  useEffect(() => {
      ...
      <div className="flex w-full flex-col items-center gap-4">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            await toast.promise(
              axios.post(
                `${config.url.API_URL}/api/administracion/parametros/lay_archivo/?tabla=PEDIDO_VW`,
                values
              ),
              {
...
LayoutDeOrdenes.auth = true;
export default LayoutDeOrdenes;
